...
@section('first-nav', __('Dashboard'))
...
@section('content')
        <div class="row">
                    ...
                    <div class="card-header pb-0">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <p class="square-after f-w-600 header-text-primary">Earnings<i
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card o-hidden product-widget">
                    <div class="card-header pb-0">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <p class="square-after f-w-600 header-text-success">Products<i
                                        class="fa fa-circle"> </i></p>
                                <h4>9856</h4>
                            </div>
                            <div class="d-flex static-widget">
                                <svg class="fill-success" width="45" height="45" viewBox="0 0 45 39" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                                    <path
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card o-hidden message-widget">
                    <div class="card-header pb-0">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <p class="square-after f-w-600 header-text-secondary">Messages<i
                                        class="fa fa-circle"> </i></p>
                                <h4>893</h4>
                            </div>
                            <div class="d-flex static-widget">
                                <svg class="fill-secondary" width="44" height="46" viewBox="0 0 44 46"
                                     xmlns="http://www.w3.org/2000/svg">
                                    <path
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card o-hidden user-widget">
                    <div class="card-header pb-0">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <p class="square-after f-w-600 header-text-info">New User<i
                                        class="fa fa-circle"> </i></p>
                                <h4>45631</h4>
                            </div>
                            <div class="d-flex static-widget">
            ...
            <div class="bg-dark col-xxl-12 col-xl-12 xl-100 col-sm-12 box-col-12">
                <div class="card o-hidden bg-transparent">
