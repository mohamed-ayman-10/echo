...
@section('page-title', __('Car Brands'))
@section('first-nav', __('Car Brands'))
    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header pb-0">
                <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-original-title="test"
                    data-bs-target="#addUser">@lang('Add New Car Brand')</a>
            </div>
            <div class="card-body">
                            ...
                            @foreach ($models as $index => $item)
                                <tr>
                                    ...
                                    <td>
                                        <ul class="action d-flex align-items-center justify-content-center gap-1">
                                            ...
                                            <li>
                                                <a href="{{route('admin.model.show', $item->id)}}" class="btn btn-outline-info" data-original-title="test">
                                                    <i class="icon-car"></i>
                                                </a>
                                            </li>
                                        </ul>
                                ...
                                <div class="modal fade" id="delete{{ $item->id }}" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">@lang('Delete Car Brand') </h5>
                                                <button class="btn-close" type="button" data-bs-dismiss="modal"
                                                    aria-label="Close"></button>
                                            </div>
                                            <div class="modal-body">
        ...
        <div class="modal fade" id="addUser" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">@lang('Add New Car Brand')</h5>
